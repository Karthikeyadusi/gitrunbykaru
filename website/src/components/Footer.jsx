    ...
    <footer className="footer-section">
      <div className="container footer-container">
        ...
        <div className="footer-links">
          ...
          <a href="https://github.com/Karthikeyadusi/gitrunbykaru/blob/main/docs/MCP_GUIDE.md" target="_blank" rel="noreferrer" className="footer-link">MCP Guide</a>
          ...
          <a href="https://github.com/Karthikeyadusi/gitrunbykaru/blob/main/docs/MCP_ARCHITECTURE_PLAN.md" target="_blank" rel="noreferrer" className="footer-link">Architecture</a>
        </div>
